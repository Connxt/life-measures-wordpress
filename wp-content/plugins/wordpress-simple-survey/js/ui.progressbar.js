  ...
  <div id="wpss_survey">
	...
	foreach($questions as $i => $question){
        ...
        $retQuiz .= '
          <fieldset class="ui-corner-all">
            ...
            <p class="form_question">'.$question['question']. '</p><div class="clear"></div>
              ...
              if (($i+1) == 14 || ($i+1) == 21 || ($i+1) == 23 || ($i+1) == 24) {
                $retQuiz .= '<div style="width:100%"><div style="width:80%;float:left;" ><div id="slider-'.$i.'"></div></div><div style="width:20%;float:left;text-align:center;font-size:14px;" id="slide-ans-'.$i.'" ></div>';
                $retQuiz .= '<script>
      ...
      <div id="thanks" class="form-panel ui-helper-hidden">
        ...
        $retQuiz .= '<input id="submitButton" type="submit" name="wpss_submit" value="'.$quiz['submit_button_txt'].'" />
        </fieldset>
      </div>';
      $retQuiz .= '<button id="next">Next &gt;</button>';
