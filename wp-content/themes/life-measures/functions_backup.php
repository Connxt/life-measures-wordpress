...
// Load QOL Blank conditional scripts
function qol_conditional_scripts() {
...
add_action('wp_print_scripts', 'qol_conditional_scripts'); // Add Conditional Page Scripts
add_action('get_header', 'enable_threaded_comments'); // Enable Threaded Comments
add_action('wp_enqueue_scripts', 'qol_header_styles'); // Add Theme Stylesheet
...
//         'interactive-map-connxt/([^/]+)/([^/]+)/([^/]+)/([^/]+)/([^/]+)/([^/]+)/?$' => 'life-measures/index.php?pagename=interactive-map-connxt&map_type=$matches[1]&map=$matches[2]&scores=$matches[3]&years=$matches[4]&locations=$matches[5]&search_type=$matches[6]',
//         );
