...
(function() {
	...
	function fa(a, b) {
		for (var c = [], d = 0; d < a.length; d++) if (0 == d) c.push(a[0]);
		else {
			var e, f, g;
			g = d - 1;
			e = 0 === g ? 0 : g - 1;
	...
	var t = !! document.createElement("canvas").getContext,
		...
		X = function(a, b, c) {
			...
			var g = 1,
				...
				k = b.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
			b = null;
			for (var t = 0; k && t < k.length; t++) if (b = k[t], "." === b && 0 > p) p = t;
			else {
				if ("%" === b) g *= 100;
				else if ("\u2030" === b) {
					g *= 1E3;
				...
				0 > p ? (h.push(b), "#" === b || "0" === b ? r++ : "," === b && q++) : (l.push(b), "#" !== b && "0" !== b || m++)
			}
			...
			for (t = n = k = m = p = 0; 0 < h.length;) if (b = h.pop(), "#" === b || "0" === b) if (p++, p === r) {
				...
				d && (c = "-" + c)
			} else 0 < g.length ? (c = g.pop() + c, m++, t++) : "0" === b && (c = "0" + c, m++, t++), 0 === t % n && (k === q && 0 < g.length) && (c = f + c);
			...
			d = "";
			for (f = !1; 0 < l.length;) b = l.shift(), "#" === b || "0" === b ? 0 < a.length && 0 !== Number(a.join("")) ? (d += a.shift(), f = !0) : "0" === b && (d += "0", f = !0) : 1 < b.length && ('"' === b[0] && '"' === b[b.length - 1] || "'" === b[0] && "'" === b[b.length - 1]) ? d += b.slice(1, b.length - 1) : "E" !== b[0] && "e" !== b[0] || "0" !== b[b.length - 1] || !/[eE][+-]*[0]+/.test(b) ? d += b : (b = 0 > s ? b.replace("+", "").replace("-", "") : b.replace("-", ""), d += b.replace(/[0]+/, function(a) {
				return K(s, a.length)
			}));
			return c + ((f ? e : "") + d)
		}, ia = function(a) {
	...
	v.prototype._updateOptions = function() {
		...
		this._options.zoomEnabled ? (this._zoomButton || (S(this._zoomButton = document.createElement("button")), M(this, this._zoomButton, "pan"), this._toolBar.appendChild(this._zoomButton), E(this._zoomButton, "click", function() {
			a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, M(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, M(a, a._zoomButton, "pan"));
			a.render()
			...
			a._toolTip.hide();
			a.zoomEnabled || a.panEnabled ? (a.zoomEnabled = !0, a.panEnabled = !1, M(a, a._zoomButton, "pan"), a._defaultCursor = "default", a.overlaidCanvas.style.cursor = a._defaultCursor) : (a.zoomEnabled = !1, a.panEnabled = !1);
	...
	v.prototype._initialize = function() {
		...
		for (var a = 0, b = 0; b < this._options.data.length; b++) if (a++, !this._options.data[b].type || 0 <= v._supportedChartTypes.indexOf(this._options.data[b].type)) {
			var c = new P(this, this._options.data[b], this.theme, a - 1, ++this._eventManager.lastObjectId);
	...
	v.prototype.render = function(a) {
		...
		this.animatedRender && 0 < this._indexLabels.length && (a = U(this.width, this.height).getContext("2d"), b.push(this.renderIndexLabels(a)));
		var p = this;
	...
	v.prototype._processStackedPlotUnit = function(a) {
		if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
			...
			for (l in k) isNaN(l) || (a = k[l], a < b.min && (b.min = a), a > b.max && (b.max = a), l < c.viewPortMin || l > c.viewPortMax || (a < b.viewPortMin && (b.viewPortMin = a), a > b.viewPortMax && (b.viewPortMax = a)))
		}
	};
		...
		if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
			for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = !1, k = !1, p = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
				var l = this.data[a.dataSeriesIndexes[h]],
					...
					m = !1,
					q = !1;
				if ("normal" === l.axisPlacement || "xySwapped" === l.axisPlacement) var n = this.sessionVariables.axisX.internalMinimum ? this.sessionVariables.axisX.internalMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity,
	...
	v.prototype.getDataPointAtXY = function(a, b, c) {
		...
		a = null;
		b = !1;
		for (c = 0; c < d.length; c++) if ("line" === d[c].dataSeries.type || "stepLine" === d[c].dataSeries.type || "area" === d[c].dataSeries.type || "stepArea" === d[c].dataSeries.type) if (e = T("markerSize", d[c].dataPoint, d[c].dataSeries) || 8, d[c].distance <= e / 2) {
			b = !0;
			break
		}
	...
	v.prototype._touchEventHandler = function(a) {
		if (a.changedTouches && this.interactivityEnabled) {
			...
			if (!(c && 1 < c.length)) {
				...
				else for (c = 0; c < b.length; c++) e = b[c], f = document.createEvent("MouseEvent"), f.initMouseEvent(e, !0, !0, window, 1, d.screenX, d.screenY, d.clientX, d.clientY, !1, !1, !1, !1, 0, null), d.target.dispatchEvent(f), a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault()
			}
		}
	};
	...
	v.prototype.renderIndexLabels = function(a) {
		...
		for (var b = this.plotArea, c = 0; c < this._indexLabels.length; c++) {
			...
			d.dataPoint.x < m.minimum || (d.dataPoint.x > m.maximum || d.dataPoint.y < n.minimum || d.dataPoint.y > n.maximum) || ("column" === d.chartType || "stackedColumn" === d.chartType || "stackedColumn100" === d.chartType || "bar" === d.chartType || "stackedBar" === d.chartType || "stackedBar100" === d.chartType || "candlestick" === d.chartType || "ohlc" === d.chartType || "rangeColumn" === d.chartType || "rangeBar" === d.chartType ? (m = n = 5, Math.abs(d.bounds.x1, d.bounds.x2), Math.abs(d.bounds.y1, d.bounds.y2), "normal" === this.plotInfo.axisPlacement ? ("inside" !== l ? (m = b.y1, q = b.y2) : (m = d.bounds.y1, q = d.bounds.y2), "horizontal" === r ? (e = d.point.x - p / 2, f = 0 <= s ? d.point.y - h / 2 - n < m + h / 2 ? "auto" === l ? Math.min(Math.max(d.point.y, m) + h / 2 + 1, q - h / 2 - n) : Math.min(m + h / 2 + 1, q - h / 2 - n) : Math.min(d.point.y - h / 2 - n + 1, q - h / 2 - n) : d.point.y + h / 2 + n > q - h / 2 - 1 ? "auto" === l ? Math.max(Math.min(d.point.y, q) - h / 2 - 1, m + h / 2 + n) : Math.max(q - h / 2 - 1, m + h / 2 + n) : Math.max(d.point.y + h / 2 + n, m + h / 2 + n)) : "vertical" === r && (e = d.point.x, f = 0 <= s ? d.point.y - n < m + p + 1 ? "auto" === l ? Math.min(Math.max(d.point.y, m) + p + 1, q) : Math.min(m + p + 1, q) : Math.min(d.point.y - n, q - 1) : d.point.y + p + n > q - 1 ? "auto" === l ? Math.max(Math.min(d.point.y,
			...
			for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
				...
				if (0 < k.length) {
					...
					q = !0;
						...
						h || q ? (b.beginPath(), b.moveTo(r, m), t && (c.beginPath(), c.moveTo(r, m)), q = h = !1) : (b.lineTo(r, m), t && c.lineTo(r, m), 0 == l % 500 && (b.stroke(), b.beginPath(), b.moveTo(r, m), t && (c.stroke(), c.beginPath(), c.moveTo(r, m))));
	...
	v.prototype.renderStepLine = function(a) {
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
				...
				b.beginPath();
				if (0 < k.length) {
					for (var q = !1, l = 0; l < k.length; l++) if (r = k[l].getTime ? k[l].x.getTime() : k[l].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax)) if ("number" !== typeof k[l].y) 0 < l && (b.stroke(), t && c.stroke()), q = !0;
					else {
						var n = m;
						r = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (r - a.axisX.conversionParameters.minimum) + 0.5 << 0;
						m = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (k[l].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (var e = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
				...
				var l = 0,
					r, m, q = [];
				c.beginPath();
				if (0 < p.length) for (l = 0; l < p.length; l++) if (r = p[l].getTime ? p[l].x.getTime() : p[l].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax)) if ("number" !== typeof p[l].y) 0 < l && (b(q), q = []);
				else {
					r = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (r - a.axisX.conversionParameters.minimum) + 0.5 << 0;
					...
					}(p[l].indexLabel || k.indexLabel) && this._indexLabels.push({
						chartType: "spline",
						dataPoint: p[l],
						dataSeries: k,
						point: {
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (h = 0; h < a.dataSeriesIndexes.length; h++) {
				var r = a.dataSeriesIndexes[h],
					m = this.data[r],
					q = m.dataPoints;
				if (0 < q.length) for (var n = 5 < l && m.bevelEnabled ? !0 : !1, g = 0; g < q.length; g++) if (c = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[g].y) {
					d = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (c - a.axisX.conversionParameters.minimum) + 0.5 << 0;
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (k = 0; k < a.dataSeriesIndexes.length; k++) {
				...
				if (0 < l.length) {
					...
					for (var Q = !0; m < l.length; m++) if (s = l[m].x.getTime ? l[m].x.getTime() : l[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax)) if ("number" !== typeof l[m].y) b(), Q = !0;
					else {
	...
	v.prototype.renderSplineArea = function(a) {
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (k = 0; k < a.dataSeriesIndexes.length; k++) {
				...
				var g = [],
					r = 0,
					m, q, n = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) + 0.5 << 0,
					s, B = null,
					u = [];
				if (0 < l.length) {
					...
					c.fillStyle = color;
					c.strokeStyle = color;
					for (c.lineWidth = h.lineThickness; r < l.length; r++) if (m = l[r].x.getTime ? l[r].x.getTime() : l[r].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax)) if ("number" !== typeof l[r].y) 0 < r && (b(), u = []);
					else {
						...
						}(l[r].indexLabel || h.indexLabel) && this._indexLabels.push({
	...
	v.prototype.renderStepArea = function(a) {
		function b() {
			x && (0 < h.lineThickness && c.stroke(), 0 >= a.axisY.minimum && 0 <= a.axisY.maximum ? u = B : 0 > a.axisY.maximum ? u = f.y1 : 0 < a.axisY.minimum && (u = e.y2), c.lineTo(q, u), c.lineTo(x.x, u), c.closePath(), c.globalAlpha = h.fillOpacity, c.fill(), c.globalAlpha = 1, t && (d.lineTo(q, u), d.lineTo(x.x, u), d.closePath(), d.fill()), c.beginPath(), c.moveTo(q, n), d.beginPath(), d.moveTo(q, n), x = {
				x: q,
				y: n
			})
		}
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (e = 0; e < a.dataSeriesIndexes.length; e++) {
				var q = a.dataSeriesIndexes[e],
					...
					s = n.dataPoints;
				n.dataPointIndexes = [];
				for (k = 0; k < s.length; k++) q = s[k].x.getTime ? s[k].x.getTime() : s[k].x, n.dataPointIndexes[q] = k, xValuePresent[q] || (g.push(q), xValuePresent[q] = !0);
				g.sort(ra)
			}
			for (e = 0; e < a.dataSeriesIndexes.length; e++) {
				var q = a.dataSeriesIndexes[e],
				...
				if (0 < g.length) {
					...
					for (k = 0; k < g.length; k++) {
						...
						if (!(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof x.y) {
							...
							0 <= n.dataPointIndexes[l] && 0 !== x.markerSize && (0 < x.markerSize || 0 < n.markerSize) && (l = n.getMarkerProperties(k, p, h, b), d.push(l), markerColor = C(G), t && d.push({
								x: p,
								y: h,
								ctx: m,
								type: l.type,
	...
	v.prototype.renderStackedArea100 = function(a) {
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (d = 0; d < a.dataSeriesIndexes.length; d++) {
				...
				var w = [];
				if (0 < g.length) {
					c = B._colorSet[k % B._colorSet.length];
					b.fillStyle = c;
					b.strokeStyle = c;
					...
					for (k = 0; k < g.length; k++) {
						...
						if (!(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof v.y) {
							...
							(v.indexLabel || B.indexLabel) && this._indexLabels.push({
		...
		if (!(0 >= c)) {
			...
			for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
				...
				if (0 < r.length) {
					...
					for (var m = 0, q = 0, e = 0; e < r.length; e++) if (f = r[e].getTime ? f = r[e].x.getTime() : f = r[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[e].y) {
						f = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (f - a.axisX.conversionParameters.minimum) + 0.5 << 0;
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
				var q = a.dataSeriesIndexes[m],
					n = this.data[q],
					s = n.dataPoints;
				if (0 < s.length) for (var B = 5 < r && n.bevelEnabled ? !0 : !1, e = 0; e < s.length; e++) if (s[e].getTime ? l = s[e].x.getTime() : l = s[e].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && null !== s[e].y && s[e].y.length && "number" === typeof s[e].y[0] && "number" === typeof s[e].y[1] && "number" === typeof s[e].y[2] && "number" === typeof s[e].y[3]) {
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
				var h = a.dataSeriesIndexes[p],
					l = this.data[h],
					r = l.dataPoints;
				if (0 < r.length) for (var m = 5 < k && l.bevelEnabled ? !0 : !1, e = 0; e < r.length; e++) if (r[e].getTime ? g = r[e].x.getTime() : g = r[e].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && null !== r[e].y && r[e].y.length && "number" === typeof r[e].y[0] && "number" === typeof r[e].y[1]) {
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
				...
				if (0 < m.length) {
					...
					b.strokeStyle = "#4572A7 ";
					for (e = 0; e < m.length; e++) if (m[e].getTime ? k = m[e].x.getTime() : k = m[e].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && null !== m[e].y && m[e].y.length && "number" === typeof m[e].y[0] && "number" === typeof m[e].y[1]) {
			...
			for (f = 0; f < a.dataSeriesIndexes.length; f++) {
				...
				if (0 < p.length) {
					...
					for (c.lineWidth = k.lineThickness; h < p.length; h++) if (l = p[h].x.getTime ? p[h].x.getTime() : p[h].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax)) if (null !== p[h].y && p[h].y.length && "number" === typeof p[h].y[0] && "number" === typeof p[h].y[1]) {
						...
						r = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (p[h].y[0] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
	...
	v.prototype.renderPie = function(a) {
		function b() {
			if (h && l) {
				...
				for (z = 0; z < l.length; z++) {
					...
					n.push(f);
					var k = e.indexLabel ? e.indexLabel : h.indexLabel ? h.indexLabel : e.label ? e.label : h.label ? h.label : "";
					...
					f.indexLabelBackgroundColor = e.indexLabelBackgroundColor ? e.indexLabelBackgroundColor : h.indexLabelBackgroundColor ? h.indexLabelBackgroundColor : null;
		...
		function c(a) {
			...
			for (b = 0; b < l.length; b++) {
				...
				if (d > c) {
					...
					} else if (0 < Math.abs(n[b].center.x - w.x) || 0 < Math.abs(n[b].center.y - w.y)) n[b].center.x = w.x + e * (1 - a), n[b].center.y = w.y + f * (1 - a), g = !0;
		...
		function d(a, b) {
			var c = a.indexLabelTextBlock.x,
				...
				l = b.indexLabelTextBlock.y + b.indexLabelTextBlock.height / 2;
					...
					for (var q, u, b = 0; b < l.length; b++) {
						...
						if (null !== z) {
							...
							var D = 0,
								D = e(q, u) - s;
							if (0 > D) {
								for (var C = u = q = 0; C < l.length; C++) C !== b && n[C].hemisphere === k.hemisphere && (n[C].indexLabelTextBlock.y < k.indexLabelTextBlock.y ? q++ : u++);
								C = D / (q + u || 1) * u;
								q = -1 * (D - C);
								var E = u = 0;
	...
	ga.prototype.render = function() {
		...
		for (var p = 0; p < this.dataSeries.length; p++) {
			var h = this.dataSeries[p],
				...
				s = h.legendMarkerBorderThickness ? h.legendMarkerBorderThickness : h.markerBorderThickness ? Math.max(1, Math.round(0.2 * q)) : 0;
	...
	P.prototype.getDataPointAtX = function(a, b) {
		...
		var c = {
			...
			h = 0,
			l = 0;
		"none" !== this.chart.plotInfo.axisPlacement && (l = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, l = 0 < l ? Math.min(Math.max((this.dataPoints.length - 1) / l * (a - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0);
		for (;;) {
			f = 0 < g ? l + e : l - e;
	...
	z.prototype.createLabels = function() {
		...
		if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType) for (c = qa(new Date(this.maximum), this.interval, this.intervalType), b = this.intervalstartTimePercent; b < c; qa(b, this.interval, this.intervalType)) a = b.getTime(), a = "axisX" === this.type && this.labels[a] ? this.labels[a] : ya(b, this.valueFormatString, this.chart._cultureInfo), a = new I(this.ctx, {
			...
			if (this.labels && this.labels.length) {
				...
				for (var f = Math.ceil(this.intervalstartTimePercent), g = !1, b = f; b < this.maximum; b += a) if (this.labels[b]) g = !0;
				else {
					g = !1;
					break
				}
	...
	z.setLayoutAndRender = function(a, b, c, d, e) {
		...
		if ("normal" === d) {
			...
			b && (f = Math.round(e.x1 + b.margin), d = Math.round(10 > e.y1 ? 10 : e.y1), g = Math.round(e.x1 + r + b.margin), k = Math.round(e.y2 - m - a.margin), b.lineCoordinates = {
				x1: g,
				y1: d,
				x2: g,
				y2: k,
	...
	z.prototype.calculateAxisParameters = function() {
		...
		if (!this.valueFormatString && (this.valueFormatString = "#,##0.##", e = Math.abs(this.maximum - this.minimum), 1 > e)) {
			b = Math.floor(Math.abs(Math.log(e) / Math.LN10)) + 2;
			...
			for (var c = 0, d = 0; d < a.length; d++) {
				...
				if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
					...
					if ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "scatter" === c.type || "area" === c.type ||
						...
						J.drawMarkers([g]);
						"undefined" !== typeof e.y2 && (g = c.getMarkerProperties(f, e.x1, e.y2, this.chart.overlaidCanvasCtx), g.size = Math.max(1.5 * g.size << 0, 10), g.borderColor = g.borderColor || "#FFFFFF", g.borderThickness = g.borderThickness || Math.ceil(0.1 * g.size), J.drawMarkers([g]))
		...
		xClipAnimation: function(a, b) {
			if (0 !== a) {
				var c = b.dest,
					d = b.source.canvas;
				c.save();
				0 < a && c.drawImage(d, 0, 0, d.width * a, d.height, 0, 0, d.width * a / H, d.height / H);
				c.restore()
			}
		},
